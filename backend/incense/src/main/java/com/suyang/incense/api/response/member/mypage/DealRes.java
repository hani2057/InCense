...
public class DealRes {
    ...
    @QueryProjection
    public DealRes(Long dealId, Gubun gubun, LocalDateTime date, String title, String perfumeBrandName,
                   String perfumeName, String image, int volume, int price, byte isDelivery, byte isClosed) {
        this.dealId = dealId;
        this.gubun = gubun;
        this.date = date;
        this.title = title;
